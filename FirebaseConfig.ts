...
import { getFirestore, collection, doc, setDoc, getDoc, onSnapshot } from 'firebase/firestore'; // Add onSnapshot
...
export { app, auth, db, collection, doc, setDoc, getDoc, onSnapshot }; // Export onSnapshot
