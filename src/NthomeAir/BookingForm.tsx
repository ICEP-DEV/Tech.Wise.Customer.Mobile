...
// Removed: import { Icon } from "react-native-elements"; // No longer needed
import DateTimePicker from "@react-native-community/datetimepicker"
import axios from "axios"
// Removed: import CustomDrawer from "../components/CustomDrawer"; // No longer needed here
import { api } from "../../api"
...
const BookingForm = ({ navigation }) => {
  ...
  // Removed: const [drawerOpen, setDrawerOpen] = useState(false);
  // Removed: const toggleDrawer = () => setDrawerOpen(!drawerOpen);
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        {/* Removed: <CustomDrawer isOpen={drawerOpen} toggleDrawer={toggleDrawer} navigation={navigation} /> */}
      </ScrollView>
    </KeyboardAvoidingView>
  )
}
